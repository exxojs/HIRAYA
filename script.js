...
const galleryTopics = [
    {
        ...
        video: "https://www.youtube.com/embed?listType=search&list=Senakulo%20Philippines"
    },
    {
        title: "Pagmamano",
        ...
        video: "https://www.youtube.com/embed?listType=search&list=Pagmamano%20Philippines"
    },
    {
        ...
        video: "https://www.youtube.com/embed?listType=search&list=Simbang%20Gabi%20Philippines"
    },
    {
        ...
        video: "https://www.youtube.com/embed?listType=search&list=Poong%20Nazareno%20Quiapo"
    },
    {
        ...
        video: "https://www.youtube.com/embed?listType=search&list=Philippine%20folk%20Catholicism"
    },
    {
        ...
        video: "https://www.youtube.com/embed?listType=search&list=Pahiyas%20Festival%20Philippines"
    },
    {
        ...
        video: "https://www.youtube.com/embed?listType=search&list=Sto%20Ni%C3%B1o%20Festival%20Philippines"
    },
    {
        ...
        video: "https://www.youtube.com/embed?listType=search&list=Pabasa%20ng%20Pasyon"
    },
    {
        ...
        video: "https://www.youtube.com/embed?listType=search&list=Visita%20Iglesia%20Philippines"
    },
    {
        ...
        video: "https://www.youtube.com/embed?listType=search&list=Eid%20al%20Fitr%20Philippines"
    }
];
...
function updateMusicButtonState() {
    ...
    if (backgroundMusic.muted || backgroundMusic.volume === 0) {
        musicIcon.classList.remove('fa-volume-high', 'fa-volume-low');
        musicIcon.classList.add('fa-volume-xmark');
    } else if (backgroundMusic.volume < 0.5) {
        musicIcon.classList.remove('fa-volume-high', 'fa-volume-xmark');
        musicIcon.classList.add('fa-volume-low');
    } else {
        musicIcon.classList.remove('fa-volume-low', 'fa-volume-xmark');
...
function openModal(index) {
    ...
    const cardElement = document.querySelectorAll('.gallery-card')[index] || null;
    const fallbackVideo = item?.video || '';
    const videoUrl = cardElement?.dataset.video || fallbackVideo;
